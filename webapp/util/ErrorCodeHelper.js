sap.ui.define([
	...
	"sap/m/Dialog"
	],function(helpers, formatter, formatterReuse, i18n, AssignmentsWarningHelper, Dialog){
		"use strict";
    ...
    ErrorCodeHelper.getMessageForErrorCodes = function(aErrorCodes, oDemand, oOrg) {
            ...
            for (var i = 0; i < aErrorCodes.length; i++) {
                if((aErrorCodes[i].code === "WFDS_SGE/064" || aErrorCodes[i].code === "WFDS_UI/101") && iDuplicateAuthCodeCounter < 1){ //not authorised
                    sErrorMsgDisplay += i18n.getText("ASSIGNMENT_FAILURE_NEW_DIALOG_NOT_AUTH_1") + " " + sServiceTeam + i18n.getText("ASSIGNMENT_FAILURE_NEW_DIALOG_NOT_AUTH_2");
                ...
                if(aErrorCodes[i].code === "ZS00/163"){ //Already staffed
                    ...
                    sErrorMsgDisplay += oDemand.FirstName + " " + oDemand.LastName + " (" + oDemand.EmpID + ") " + i18n.getText("ASSIGNMENT_FAILURE_NEW_DIALOG_STAFFED_3");                   
                    iErrorCodeCounter++;
                ...
                if(aErrorCodes[i].code === "WFDS_SGE/429"){
                    ...
                    sErrorMsgDisplay += " " + i18n.getText("ASSIGNMENT_FAILURE_NEW_DIALOG_RESOURCE_VALIDITY_DATES_2") + " " + aMessageParts[2].slice(1, 11);
        ...
        var sErrorMsg = "";
               ...
               for (var i = 0; i < aErrorCodes.length; i++) {
                    if(aErrorCodes[i].severity === "error"){
                        sErrorMsg = i18n.getText("ASSIGNMENT_FAILURE_NEW_DIALOG_UNEXPECTED_ERROR_1") + " " + aErrorCodes[i].code + i18n.getText("ASSIGNMENT_FAILURE_NEW_DIALOG_UNEXPECTED_ERROR_2");
                        break;
                    }
               }
        return sErrorMsg;
